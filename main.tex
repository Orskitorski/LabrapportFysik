...
\begin{titlepage}
	...
	\begin{abstract}
        We were given the task to calculate the speed of an object rolling down an incline. To do this we used a real life model that we rolled down a small incline and then used a program called physlets.org to calculate the distance traveled and the amount of time it took to travel that distance.
    \end{abstract}
    \end{otherlanguage}
